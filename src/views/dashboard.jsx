    ...
    <>
      ...
      >
        ...
        <nav
          ...
          className={`fixed bottom-0 left-0 top-0 z-50 flex h-full w-full flex-col border-r border-gray-800 bg-gray-800 text-gray-200 transition-transform duration-500 ease-out lg:w-64 ${
        ...
        >
          ...
          <div className="flex h-16 w-full flex-none items-center justify-between bg-gray-600/25 px-4 lg:justify-center">
            ...
            >
              <svg
                className="hi-mini hi-cube-transparent inline-block size-5 text-teal-400 transition group-hover:scale-110"
          ...
          <div className="overflow-y-auto">
            <div className="w-full p-4">
              <nav className="space-y-1">
                <a
                  href="#"
                  className="group flex items-center gap-2 rounded-lg border border-transparent bg-gray-700/75 px-2.5 text-sm font-medium text-white"
                >
                  <span className="flex flex-none items-center text-gray-300">
                    <svg
                ...
                >
                  ...
                  <span className="grow py-2">Assessments</span>
                </Link>
                <a
                  href="#"
                  className="group flex items-center gap-2 rounded-lg border border-transparent px-2.5 text-sm font-medium text-gray-200 hover:bg-gray-700/75 hover:text-white active:border-gray-600"
        ...
        >
          <div className="container mx-auto flex w-full flex-col px-4 text-center text-sm md:flex-row md:justify-between md:text-left lg:px-8 xl:max-w-7xl">
            <div className="pb-1 pt-4 md:pb-4">
              <a
                href="https://github.com/akaash1502"
                target="_blank"
